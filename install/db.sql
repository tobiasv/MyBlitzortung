...
CREATE TABLE IF NOT EXISTS `{BO_DB_PREF}stations` (
  ...
  `bo_station_id` smallint(5) unsigned NOT NULL,
  `bo_user_id` smallint(5) unsigned NOT NULL,
  ...
  `amp_gains` varchar(40) NOT NULL,
  `amp_antennas` varchar(30) NOT NULL,
  `amp_firmwares` varchar(100) NOT NULL,
