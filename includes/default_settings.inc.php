...
@define("BO_GRAPH_STAT_STRIKES_ADV_GROUP_MINUTES",  15);
...
@define("BO_GRAPH_STAT_STRIKES_DEVIATIONS_AVG_WIDTH_2",  2);
@define("BO_GRAPH_STAT_STRIKES_DEVIATIONS_AVG_COLOR_L3", '#00f@0.7');
@define("BO_GRAPH_STAT_STRIKES_DEVIATIONS_AVG_COLOR_F3", '#00f@0.9');
