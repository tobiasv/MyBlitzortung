...
/*   feature. The URLs should end with an "?"                      */
...
@define("BO_GRAPH_STAT_RATIO_BEAR_WINDROSE_NUMBERS_COLOR1", '00f');
@define("BO_GRAPH_STAT_RATIO_BEAR_WINDROSE_NUMBERS_COLOR2", '060');
